  ...
  return (
    <div className="flex flex-col rounded-lg border border-border-subtle bg-surface-1">
      <div className="flex items-center justify-between border-b border-border-subtle px-3 py-2.5">
        ...
        <Link href="/approvals" className="flex items-center gap-1 text-[11px] font-medium text-indigo transition-colors hover:text-indigo/80">
        ...
        {topApprovals.map((approval) => (
          <div key={approval.id} className="flex items-center gap-3 px-3 py-3">
            ...
            <div className="flex shrink-0 items-center gap-1.5">
              <button className="rounded-md bg-success px-3 py-1.5 text-[11px] font-semibold text-white transition-colors hover:bg-success/90">
                Approve
              </button>
              <button className="rounded-md border border-border-base bg-surface-2 px-3 py-1.5 text-[11px] font-semibold text-text-secondary transition-colors hover:text-text-primary">
                Skip
              </button>
            </div>
          </div>
